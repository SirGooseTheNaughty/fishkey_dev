// --------- BUTTON BACKGROUND --------- //
let targetButtons = $('.tilda_bullshit_vzhuh');
...
// --------- ПРОСТОЙ ВЖУХ --------- //
let simpleButton = $('.tilda_simple_vzhuh'); // '[data-elem-id=" "] div'
const vzhukhStyle = {
    firstColor: 'red',			// код первого цвета
    secondColor: 'blue',		// код второго цвета
    firstPosition: 'left',		// right/left для горизонтальной смены или top/bottom для вертикальной
...
const vzhukhButtonStyle = {
    'background': `linear-gradient(${vzhukhStyle.whereTo}, ${vzhukhStyle.firstColor} 50%, ${vzhukhStyle.secondColor} 50%)`,
...
const burgerCubicWrapper = $('.burgerCubicWrapper');
