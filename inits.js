...
<script>
    vectorDraw_init({
        selectors: `                                // селекторы элементов для векторов
            [data-elem-id="1606915054502"], 
            [data-elem-id="1606917547773"],
        `,
        svgs: [                                     // векторы
        ...
        offsets: [                                  // отступы от низа экрана (если scroll)
            200, 200
        ]
    });
</script>
...
<script>
    vectorWrite_init({
        ...
        minWidth: 1200,                                 // минимальная ширина экрана для анимации
        offset: 200,                                    // отступ от низа экрана
...
<script>
    const txtAppear = textApp_init({
        ...
        offsets: [500, 500, ...],                           // отступы от низа экрана для появления
...
<script>
    const tw_startWriting = typeWriter_init({
        ...
        minWidth: '1200',                               // минимальная ширина экрана для анимации
        offset: 400                                     // отступ от низа экрана для анимации
    });
</script>
...
<script>
    lettersAppear_init({
        ...
        minWidth: 1200,                                 // минимальная ширина экрана для анимации
        offset: 500,                                    // отступ от низа экрана для анимации
