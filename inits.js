...
<script>
    textWrap_init({
        ...
        isTriggerMoving: true,                      // будет ли селектор двигаться вместе с обрезкой текста
        isTriggerFlipping: false,                   // будет ли слектор переворачиваться в разных состояниях
